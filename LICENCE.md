...
This repository contains scripts – such as `New-Post.ps1`, `Remove-Cache.ps1`, and `Start-Test.ps1`. You are allowed to take those scripts and do what you want so long as you attribute me in your project's attributions.

However, there may be exceptions (you will tell when you see them). I expect you to follow those different rules accordingly.

## Concerning Any Website Contents in this Repository
...
### In the Case of Textual Works

You may provide attributions by providing a link to my website (which, at the moment, is [franciscosp.com](https://franciscosp.com/)), my name, and (optionally) my [Twitter](https://twitter.com/pacismo) handle, @Pacismo.

### In the Case of Video Works

You may provide attributions similarly to those of textual works, should you use services such as [YouTube](https://youtube.com/) which have a description box or a feature for including attributions.

However, in all cases, you should mention me by name ("Francisco", "Francisco Santana", "Santana", or "Mr. Santana"; "he" is also accepted *if* the pronoun draws back to me by context) whenever you are citing or paraphrasing information from this site, and mention the site ([franciscosp.com](https://franciscosp.com/)) at least once (which can be done verbally (so long as it is heard properly) or textually (as part of the credits or inline (like in news reports when they show a document), so long as it is visible)).
...
* This applies to *everyone, everywhere, anytime*.

Feel free to contact me on [Twitter](https://twitter.com/pacismo) if you have any questions.

## "What About Your Brilliant Jokes?"

They're jokes: unless they're standalone, they may not even work in your context. Still, though, the attribution would be nice.

...
export default class Pipeline
{
     ...
     */
    constructor(simulator, table, fetch_cell, decode_cell, execute_cell, memory_cell, writeback_cell) {
    ...
    show_details(stage) {
        ...
        close_popup(`Current State: ${stage[0].toUpperCase() + stage.substring(1)}`, c => {

...
export default class Watchlist
{
    ...
    create_entry(address, type, read_type) {
        ...
        this.entries[address] = { row, value : value_cell, type : type_cell, read_type }
    }
    ...
    update() {
        Object.entries(this.entries)
            .forEach(([ k, v ]) => v.value.textContent = this.simulator.read_address(Number.parseInt(k), v.read_type));
    }
}
